...
func generateFullReviewPreviewData() -> FullReview {
    ...
    return FullReview(review: review, likes: [Like(id: "123", created: Date(), userId: "1234", reviewId: review.id), Like(id: "12345", created: Date(), userId: "123", reviewId: review.id), Like(id: "123456", created: Date(), userId: "123", reviewId: review.id)], replies: [Reply(id: "1", created: Date(), userId: "1234", reviewId: review.id, text: "This is a sample reply! Something something Something something Something something Something something Something something  vSomething something Something somethingSomething somethingSomething somethingv Something something dfgdf"),Reply(id: "2", created: Date().addingTimeInterval(-1000), userId: "12345", reviewId: review.id, text: "This is a sample reply! -1000"),Reply(id: "3", created: Date(), userId: "123456", reviewId: review.id, text: "This is a sample reply! Something something Something something Something something Something something Something something  vSomething something Something somethingSomething somethingSomething somethingv Something something dfgdf"),Reply(id: "4", created: Date().addingTimeInterval(-459874985), userId: "1234567", reviewId: review.id, text: "This is a sample reply! -459874985"),Reply(id: "5", created: Date(), userId: "12345678", reviewId: review.id, text: "This is a sample reply!")], pics: [Pic(id: "123", created: Date(), reviewId: "123", width: 900, height: 1600), Pic(id: "123", created: Date(), reviewId: "123", width: 900, height: 1600), Pic(id: "123", created: Date(), reviewId: "123", width: 900, height: 1600)])
}
