...
struct LocationReviewsView: View {
    ...
    func loadReviews() async {
        ...
        let reviews_res = await belocal.getReviewsForLocation(token: auth.token, location_name: self.uniqueLocation.locationName, latitude: self.uniqueLocation.latitude, longitude: self.uniqueLocation.longitude)
