...
struct DeleteAccountView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                Text("Disclaimer: Pressing the above 'Delete Account' button will permanently delete your account and all associated data immediately. belocal has no way to recover this information once deleted. You can create a new account at anytime.").font(.caption)
            }.padding()
