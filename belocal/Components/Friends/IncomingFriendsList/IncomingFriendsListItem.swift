...
struct IncomingFriendsListItem: View {
    ...
    func acceptFriend() async {
        ...
        let result = await belocal.acceptFriend(token: auth.token, requestId: requestId)
    ...
    func rejectFriend() async {
        ...
        let result = await belocal.rejectFriend(token: auth.token, requestId: requestId)
    ...
    func ignoreFriend() async {
        ...
        let result = await belocal.ignoreFriend(token: auth.token, requestId: requestId)
